...
//       <div className="absolute flex  items-end bottom-0 left-0 w-full h-full rounded-md p-4 bg-gradient-to-t from-indigo-950/100 via-indigo-950/50 to-sky-500/30 to-80% group-hover:to-90%">
